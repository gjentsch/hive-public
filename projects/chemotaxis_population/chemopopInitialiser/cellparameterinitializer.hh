	...
	/**
		...
		class CellParameterInitializer : public AgentInitializer {
			public:
				...
				int get_n_cells() const { return this->getNumberAgents(); };
				int getNumberCells() const { return this->getNumberAgents(); };
				...
				void setNextAgentParameters(Agent *cell);
				...
				void parseFileWillsModel(ifstream& input);
				void parseFileWillsModelWithVariableMotors(ifstream& input);
